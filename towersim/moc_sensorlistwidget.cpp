...
static const char qt_meta_stringdata_SensorListWidget[] = {
    "SensorListWidget\0"
};
...
const QMetaObjectExtraData SensorListWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SensorListWidget::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_SensorListWidget,
      qt_meta_data_SensorListWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SensorListWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SensorListWidget))
        return static_cast<void*>(const_cast< SensorListWidget*>(this));
