...
class nRF24L01P_PTX
{
   public:
      ...
      // Enables dynamic payloads on the given pipe
      void EnableDynamicPayload(int Pipe, bool Enable = true);
      ...
      // Stream a packet - continuous non-blocking mode
      int StreamPacket(char* Buf, int Size);
